...
├── references/
│   └── voice_core/         # Prototype predecessor (reference only)
...
Boat is the production evolution of the `voice_core` prototype. All architectural learnings, rejected approaches, and AEC insights from voice_core are carried forward into Boat's foundation. See [`references/voice_core/`](references/voice_core/) for the prototype.
